...
|fbs|fasting blood sugar &gt (1 = true; 0 = false)|
...
### K-Neighbors Classifier
&emsp;&emsp;使用sklearn包的KNeighborsClassifier方法，利用循环K值分成1-21近邻个数
...
__Decision Tree Classifier__ , __Random Forest Classifier__ 方法进行分析，综合几种机器学习在测试集的得分情况可以看出，在
 __K-Neighbors__ 方法中，__K__ 值取 __8__ 时，测试集分值最高，预测准确率 __87%__